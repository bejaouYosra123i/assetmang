        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfInvestment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvestmentRequests_Profiles_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvestmentItems_InvestmentRequests_InvestmentRequestId",
                        column: x => x.InvestmentRequestId,
                        principalTable: "InvestmentRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvestmentItems_InvestmentRequestId",
                table: "InvestmentItems",
                column: "InvestmentRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_InvestmentRequests_CreatedById",
